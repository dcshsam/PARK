...
const TEAM_BADGE: Record<Team, string> = {
  SAP: "bg-blue-100 text-blue-700 dark:bg-blue-500/15 dark:text-blue-300",
  NONSAP: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300",
};

function emptyEditor(): EditorState {
  return { name: "", email: "", phone: "", role: "other", team: "SAP" };
}

export function TeamMemberSettings() {
  const router = useRouter();
  const [members, setMembers] = useState<TeamMember[]>(() =>
    typeof window === "undefined" ? [] : getTeamMembers()
  );
            ...
            <div className="divide-y divide-border-subtle">
              {members.map((member) => (
                ...
                >
                  ...
                  <div className="col-span-2 sm:col-span-2">
                    <Badge className={cn("rounded-md px-2 py-0.5 text-xs font-semibold", TEAM_BADGE[member.team])}>
                      {member.team}
                    </Badge>
                  </div>
